    ...
    <div class="container">
        ...
        <div class="block-header">
            <h3 class="block-header__title">
                @isset($section)
                <a href="{{ route('home-sections.products', $section) }}" style="color:inherit;">{{ __($title) }}</a>
                @else
                {{ __($title) }}
                @endisset
            </h3>
                ...
                <div class="products-list__item">
                    <div class="product-card" data-id="{{ $product->id }}" data-max="{{ $product->should_track ? $product->stock_count : -1 }}">
                        ...
                        <div class="product-card__badges-list">
                            @if(! $in_stock)
                            <div class="product-card__badge product-card__badge--sale">@lang('Sold')</div>
                            @endif
                        ...
                        <div class="product-card__actions">
                            <div class="product-card__availability">@lang('Availability'):
