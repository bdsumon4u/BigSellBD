            ...
            <div class="product product--layout--standard" data-layout="standard">
                <div class="product__content" data-id="{{ $product->id }}" data-max="{{ $product->should_track ? $product->stock_count : -1 }}">
                    ...
                    <div class="product__info">
                        ...
                        <div class="w-100 mb-2 border-top pt-2">@lang('Product Code'): <strong>{{ $product->sku }}</strong></div>
                        ...
                        <ul class="product__meta">
                            <li class="product__meta-availability w-100 mb-2">
                                <big>
                                    ...
                                    @else
                                        <span class="text-{{ $product->stock_count ? 'success' : 'danger' }}">{{ $product->stock_count }} @lang('In Stock')</span>
                                    @endif
                                </big>
                            </li>
                        </ul>
                        ...
                        <div class="product__sidebar">
                            ...
                            <form class="product__options">
                                <div class="form-group product__option">
                                    <label class="product__option-label" for="product-quantity">@lang('Quantity')</label>
                                ...
                                <div class="call-for-order">
                                    ...
                                    <div style="padding: 10px;margin-bottom: 10px;font-weight: bold;color: red;padding-left: 85px;">
                            ...
                            <div class="product__tags tags">
                                @if($product->brand)
                                    <p class="text-secondary mb-2">
                                        @lang('Brand'): <a href="{{ route('brands.products', $product->brand) }}" class="text-primary badge badge-light"><big>{{ $product->brand->name }}</big></a>
                                    </p>
                                @endif
                                <div class="">
                                    <p class="text-secondary mb-2 d-inline-block mr-2">@lang('Categories'):</p>
